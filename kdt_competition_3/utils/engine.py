    ...
    for images, targets in dataloader:
        ...
        for image, target in zip(images, targets):
            ...
            for i, pred_box in enumerate(pred_boxes):
                ...
                plt.text(pred_box[0], (pred_box[1] - 3), s=pred_class[i], c='b')
                plt.text(pred_box[0], (pred_box[1] + 4), s=pred_score[i], c='b')
            for i, box in enumerate(target['boxes']):
                ...
                plt.text(box[2], (box[1] - 3), s=CLASS_INFO[target['labels'][i]], c='r')
